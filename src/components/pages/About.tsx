    ...
    return (
        <section className={'min-h-screen flex justify-center place-items-center p-5 mt-10 sm:mt-0'}>
            ...
            <div className={'flex max-w-5xl gap-12 justify-center place-items-center flex-col sm:flex-row'}>
                <img className={'rounded-full w-full h-64 sm:w-52 sm:h-xxl'}
                ...
                <article >
                    <h2 className={'text-5xl font-bold mb-10'}>It's nice to meet you.</h2>
                    <p className={'tracking-wide mb-5 text-center sm:text-left'}>
                    ...
                    <p className={'tracking-wide mb-5 text-center sm:text-left'}>
                        Want to know more or grab a coffee? Feel free to <a href="#contact">get in touch.</a>
                    </p>
                </article>
            </div>
        </section>
